...
const seatAdminController = require('../controllers/seatAdminController');
...
router[removeRoute]('/accounts/:id', auth, requireRole('super_admin'), adminController.deleteAccount);
...
router[removeRoute]('/rooms/:id', auth, requireRole('super_admin'), adminController.deleteRoom);

router.post('/seats/batch', auth, requireAdmin, adminScope.loadAdminScope, adminScope.roomFromBody('roomId'), seatAdminController.rebuildSeats);
router.put('/seats/:id', auth, requireAdmin, adminScope.loadAdminScope, adminScope.seatFromParam('id'), adminController.updateSeat);
router[removeRoute]('/seats/:id', auth, requireAdmin, adminScope.loadAdminScope, adminScope.seatFromParam('id'), adminController.deleteSeat);
...
router[removeRoute]('/buildings/:id', auth, requireRole('super_admin'), adminController.deleteBuilding);
...
router[removeRoute]('/managers/:id', auth, requireRole('super_admin'), adminController.deleteManager);
...
router[removeRoute]('/announcements/:id', auth, requireAdmin, adminController.deleteAnnouncement);
...
router.post('/upload', auth, requireAdmin, adminScope.loadAdminScope, secureUploadService.imageUpload('file', 'admin-image'), adminController.uploadFile);
