...
router.get('/pending', auth, requireAdmin, adminScope.loadAdminScope, scopedQueryController.pendingAuditList);
...
router.get('/counselor/pending', auth, requireAdmin, adminScope.loadAdminScope, scopedQueryController.pendingAuditList);
